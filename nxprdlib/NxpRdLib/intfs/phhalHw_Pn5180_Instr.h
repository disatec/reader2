...
** $Author:nxp62726 $
* $Revision$ (NFCRDLIB_V4.010.03.001609  (NFCRDLIB_V4.010.01.001603 : 3637 ))
* $Date: 2015-08-26 20:13:19 +0530 (Wed, 26 Aug 2015) $
*/
...
#define PHHAL_HW_PN5180_GET_INSTR_MFC_AUTHENTICATE                             0x0CU  /**< Perform authentication on an activated Mifare Classic card. */
...
#define PHHAL_HW_PN5180_AUTOCOLL_MODE_AUTONOMOUS_WITHOUT_STANDBY          0x02U  /**< Autocoll terminates only upon successful activation. PN5180 does use standby mode. */
   ...
   /**
    * \name PN5180 Mifare authentication key type definition and length defines
    */
    /*@{*/
...
#define PHHAL_HW_PN5180_INVALID_REG_START_ADDRESS                          0x43U /**< Regs from 0x42 to 0x7F are not implemented Update everytime regmap changes due to reg addition.*/
#define PHHAL_HW_PN5180_INVALID_REG_END_ADDRESS                            0x7FU /**< Regs from 0x29 to 0x7F are not implemented Update everytime regmap changes due to reg addition.*/
...
#define PHHAL_HW_PN5180_MAX_WAKEUP_COUNTER                                 (2690)                                                            /**< Maximum value for wakeup counter in msecs. */
...
#define PHHAL_HW_PN5180_MAX_EPC_GEN2_TIMESLOT                              (PHHAL_HW_PN5180_EPC_GEN2_TIMESLOT_SINGLE_SELECT_TAG) /**< Maximum EPC GEN2 TIMESLOT parameter. */
    ...
    */
    /*@{*/
#define PHHAL_HW_PN5180_MIN_RF_TX_CONFIGURATION_INDEX                      0x00  /**< Minimum RF configuration index for TX. */
#define PHHAL_HW_PN5180_MAX_RF_TX_CONFIGURATION_INDEX                      0x1C  /**< Maximum RF configuration index for TX. */
#define PHHAL_HW_PN5180_MIN_RF_RX_CONFIGURATION_INDEX                      0x80  /**< Minimum RF configuration index for RX. */
#define PHHAL_HW_PN5180_MAX_RF_RX_CONFIGURATION_INDEX                      0x9D  /**< Maximum RF configuration index for RX. */
...
#define PHHAL_HW_PN5180_CURRENT_RF_CONFIGURATION_INDEX                     0xFF  /**< Current RF configuration index for TX/RX. */
...
#define PHHAL_HW_PN5180_MAX_RF_REGS                                        0x43  /**< Max RF config regs- Not in Spec-Discussed with JP. */
