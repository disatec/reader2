...
* $Revision: 4258 $ (NFCRDLIB_V4.010.03.001609 : 4187 $ (NFCRDLIB_V4.010.01.001603 : 3924 ))
...
*/
/*@{*/
#define PHAC_DISCLOOP_NFC_ACTIVITY_VERSION_1_0                0x01    /**< Supports NFC Activity version 1.0. */
#define PHAC_DISCLOOP_NFC_ACTIVITY_VERSION_1_1                0x02    /**< Supports NFC Activity version 1.1. This is default. */
/*@}*/
...
*/
typedef enum phacDiscLoop_Profile{
...
*/
typedef enum phacDiscLoop_Sw_PollState{
    PHAC_DISCLOOP_POLL_STATE_UNKNOWN = 0,                             /**< Unknown. */
    PHAC_DISCLOOP_POLL_STATE_DETECTION,                               /**< Starts passive poll mode in Technology Detection stage. */
    PHAC_DISCLOOP_POLL_STATE_COLLISION_RESOLUTION,                    /**< Starts passive poll mode in Collision Resolution stage. */
    PHAC_DISCLOOP_POLL_STATE_REMOVAL                                  /**< Starts passive poll mode in Card Removal stage (Only for EMVCo mode). */
...
*/
typedef enum phacDiscLoop_Sw_EntryPoints{
...
*/
typedef enum phacDiscLoop_Sw_NfcTech{
...
*/
typedef struct phacDiscLoop_Sw_TypeA_Info
{
    uint8_t bTotalTagsFound;                                          /**< Number of type A tags found. */
    uint8_t bT1TFlag;                                                 /**< Flag to indicate detected tag is T1T Tag. */

#ifdef NXPBUILD__PHAC_DISCLOOP_TYPEA_JEWEL_TAGS
    uint8_t abHr[PHAC_DISCLOOP_JEWEL_HR_LENGTH];                      /**< Header ROM mask of T1T Tag. */
    ...
    /** Structure info required for ISO/IEC 14443 communication */
        ...
        struct phacDiscLoop_TypeA_I3P3
        {
            ...
            uint8_t bTagState;                                        /**< State of TYPEA TAG. */
...
*/
typedef struct phacDiscLoop_Sw_TypeB_Info
{
    ...
    struct phacDiscLoop_TypeB_I3P3B
    {
        ...
        uint8_t bTagState;                                            /**< State of TYPEB TAG. */
...
*/
typedef struct phacDiscLoop_Sw_TypeF_Info
{
    ...
    struct phacDiscLoop_TypeF_Tag_Info
    {
        ...
        uint8_t bTagState;                                                                  /**< State of TYPEF TAG. */
...
*/
typedef struct phacDiscLoop_Sw_TypeV_Info
{
    ...
    }aTypeV[PHAC_DISCLOOP_CFG_MAX_CARDS_SUPPORTED];
}phacDiscLoop_Sw_TypeV_Info_t;

/**
* \brief 18000p3m3 parameter structure
*/
typedef struct phacDiscLoop_I18000p3m3_Info
{
    ...
    }aI18000p3m3[PHAC_DISCLOOP_CFG_MAX_CARDS_SUPPORTED];
...
typedef struct phacDiscLoop_Sw_DataParams
{
     ...
     *
     * #RD_LIB_MODE_EMVCO -> Run in EMVCO mode as per the EMVCo 2.3.1a Digital specification.\n
...
*  \brief Discovery loop component as per NFC Forum Activity Specification 1.1 and EMVCo Digital 2.3.1a specification.
*
*  Discovery loop implements poll mode based on NFC Activity Specification 1.1
*  (backward compatibility with version 1.0) and EMVCo Specification 2.3.1a. Listen
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEB_DRI                        0x34U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEB_DSI                        0x35U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_I3P4_DRI                   0x42U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_I3P4_DSI                   0x43U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_DID                    0x44U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_LRI                    0x45U
 ...
 * Default is #PH_OFF.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_NAD_ENABLE             0x46U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_NAD                    0x47U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_GI_LEN                 0x48U

/**
 * Get ATR response length from Type A P2P devices in passive poll mode.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_P2P_ATR_RES_LEN            0x49U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_DID                    0x50U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_LRI                    0x51U
 ...
 * Default is #PH_OFF.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_NAD_ENABLE             0x52U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_NAD                    0x53U
 ...
 * Default is 0.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_GI_LEN                 0x54U

/**
 * Get ATR response length from Type A P2P devices in passive poll mode.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEF_P2P_ATR_RES_LEN            0x55U
