...
*/
/*@{*/
#define PHPAL_I14443P4A_RATS_RETRY_MAX    1   /**< Maximum retry value of RATS during transmission and timeout error.*/
#define PHPAL_I14443P4A_RATS_RETRY_MIN    0   /**< Minimum retry value of RATS during transmission and timeout error.*/
/*@}*/
