...
* $Revision: 4258 $ (NFCRDLIB_V4.010.03.001609 : 4184 $ (NFCRDLIB_V4.010.01.001603 : 3148 ))
...
#define PHAL_I18000P3M3_SW_ID   0x01    /**< ID for Software I18000P3M3 layer. */
...
*/
/*@{*/
#define PHAL_I18000P3M3_ERR_OTHER               (PH_ERR_CUSTOM_BEGIN+0) /**< Other Error. */
#define PHAL_I18000P3M3_ERR_MEMORY_OVERRUN      (PH_ERR_CUSTOM_BEGIN+1) /**< Memory overrun. */
#define PHAL_I18000P3M3_ERR_MEMORY_LOCKED       (PH_ERR_CUSTOM_BEGIN+2) /**< Memory locked. */
#define PHAL_I18000P3M3_ERR_INSUFFICIENT_POWER  (PH_ERR_CUSTOM_BEGIN+3) /**< Insufficient power. */
#define PHAL_I18000P3M3_ERR_NON_SPECIFIC        (PH_ERR_CUSTOM_BEGIN+4) /**< Non-specific error. */
/*@}*/
...
phStatus_t phalI18000p3m3_BlockWrite(
                                     ...
                                     uint8_t * pData            /**< [In] Words to write; uint8_t[2 * \c bWordCount]. */
                                     );
...
phStatus_t phalI18000p3m3_BlockPermaLock(
    ...
    uint8_t * pMask,            /**< [In] Specifies which memory blocks a tag permalocks; uint8_t[2 * \c bBlockRange] Ignored if \c bReadLock is \c 0 */
