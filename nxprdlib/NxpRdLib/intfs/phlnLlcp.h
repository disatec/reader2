...
* $Revision: 4258 $ (NFCRDLIB_V4.010.03.001609 : 4194 $ (NFCRDLIB_V4.010.01.001603 : 3849 ))
 ...
 * \brief Implementation of NFCForum Logical Link Control Protocol (LLCP) 1.1
* @{
*/

#define PHLN_LLCP_SW_ID      0x01                                                            /**< ID for Software LLCP layer. */
...
typedef struct phlnLlcp_Transport_Socket{
    phOsal_SemaphoreHandle_t           xSema;                                                /**< Handle to the semaphore. */
    phOsal_SemaphoreHandle_t           xRxSema;                                              /**< Handle to the Receive semaphore. */
...
* \brief This Component implements the NFCForum Logical Link Control Protocol (LLCP) version 1.1.
*
...
*/
/*@{*/
#define PHLN_LLCP_SOCKET_WAITONCONN              0x01                                        /**< Socket is blocked on new remote connection. */
#define PHLN_LLCP_SOCKET_CONN_PEND               0x02                                        /**< Status indicates Connect PDU to be sent. */
#define PHLN_LLCP_SOCKET_DISC_PEND               0x04                                        /**< Status indicates Disconnect PDU to be sent. */
#define PHLN_LLCP_SOCKET_DISC                    0x10                                        /**< Received a Disconnect/Disconnect Mode(DM) PDU. */
#define PHLN_LLCP_SOCKET_INFO_EX                 0x20                                        /**< Information Exchange. */
#define PHLN_LLCP_SOCKET_INFO_SEND_EX            0x40                                        /**< Send Information and update after next Packet is received. */
#define PHLN_LLCP_SOCKET_SNL                     0x60                                        /**< SNL Exchange. */
/*@}*/
...
#define PHLN_LLCP_MAGIC_NUM_BYTE1                0x46                                        /**< LLCP Magic Byte-1. */
#define PHLN_LLCP_MAGIC_NUM_BYTE2                0x66                                        /**< LLCP Magic Byte-2. */
#define PHLN_LLCP_MAGIC_NUM_BYTE3                0x6D                                        /**< LLCP Magic Byte-3. */
...
*/
/*@{*/
#define PHLN_LLCP_TLV_TYPE_VERSION               0x01                                        /**< Type Field value in Version TLV. */
#define PHLN_LLCP_TLV_TYPE_MIUX                  0x02                                        /**< Type Field value in MIUX (Maximum Information Unit Extension) TLV. */
#define PHLN_LLCP_TLV_TYPE_WKS                   0x03                                        /**< Type Field value in WKS (Well-Known Service List) TLV. */
#define PHLN_LLCP_TLV_TYPE_LTO                   0x04                                        /**< Type Field value in LTO (Link Time-Out) TLV. */
#define PHLN_LLCP_TLV_TYPE_RW                    0x05                                        /**< Type Field value in RW (Receive Window Size) TLV. */
#define PHLN_LLCP_TLV_TYPE_SN                    0x06                                        /**< Type Field value in SN (Service Name) TLV. */
#define PHLN_LLCP_TLV_TYPE_OPT                   0x07                                        /**< Type Field value in OPT (Option) TLV. */
#define PHLN_LLCP_TLV_TYPE_SDREQ                 0x08                                        /**< Type Field value in SDREQ (Service Discovery Request) TLV. */
#define PHLN_LLCP_TLV_TYPE_SDRES                 0x09                                        /**< Type Field value in SDRES (Service Discovery Response) TLV. */

#define PHLN_LLCP_TLV_LENGTH_VERSION             0x01                                        /**< Length Field value in Version TLV. */
#define PHLN_LLCP_TLV_LENGTH_MIUX                0x02                                        /**< Length Field value in MIUX Maximum Information Unit Extension) TLV. */
#define PHLN_LLCP_TLV_LENGTH_WKS                 0x02                                        /**< Length Field value in WKS (Well-Known Service List) TLV. */
#define PHLN_LLCP_TLV_LENGTH_LTO                 0x01                                        /**< Length Field value in LTO (Link Time-Out) TLV. */
#define PHLN_LLCP_TLV_LENGTH_RW                  0x01                                        /**< Length Field value in RW (Receive Window Size) TLV. */
#define PHLN_LLCP_TLV_LENGTH_OPT                 0x01                                        /**< Length Field value in OPT (Option) TLV. */
#define PHLN_LLCP_TLV_LENGTH_SDRES               0x02                                        /**< Length Field value in SDRES TLV. */

#define PHLN_LLCP_TLV_MIUX_MASK                  ( 1 << 0x01 )                               /**< Mask used to set MIUX in 'bAvailableTlv' of \ref phlnLlcp_LMDataParams_t of Local Link. */
#define PHLN_LLCP_TLV_WKS_MASK                   ( 1 << 0x02 )                               /**< Mask used to set WKS in 'bAvailableTlv' of \ref phlnLlcp_LMDataParams_t of Local Link. */
#define PHLN_LLCP_TLV_LTO_MASK                   ( 1 << 0x03 )                               /**< Mask used to set LTO in 'bAvailableTlv' of \ref phlnLlcp_LMDataParams_t of Local Link. */
#define PHLN_LLCP_TLV_OPT_MASK                   ( 1 << 0x04 )                               /**< Mask used to set OPT in 'bAvailableTlv' of \ref phlnLlcp_LMDataParams_t of Local Link. */

#define PHLN_LLCP_TLV_VERSION_VALUE              0x11                                        /**< Major version number is 1, Minor version number is 1. Indicating NFCForum LLPC 1.1 Specification. */
/*@}*/
...
*/
/*@{*/
#define PHLN_LLCP_MIU                            248                                         /**< Maximum number of bytes in the information field of an LLC PDU that the local LLC is able to receive. */
#define PHLN_LLCP_TLV_MIUX_VALUE                 (PHLN_LLCP_MIU - 128)                       /**< MIUX (Maximum Information Unit Extension) = Maximum Information Unit (MIU) - 128. */
/*@}*/
...
* These are sent as part of Disconnected Mode (DM) PDU reason field. Refer LLCP1.1 specification section 4.3.8 table 4.
*/
/*@{*/
#define PHLN_LLCP_PDU_DM_DISC         0x00 /**< Indicates the Logical Link Control (LLC) has received a DISC PDU and is now logically disconnected from the data link connection. */
...
* (DSSAP and SSAP equal to 0) is disconnected and peer need to re-establish the connection as per NFC Forum LLCP Specification 1.1, sec 5.6.4.5.
*
* \return Status code
...
* be posted by the \ref phlnLlcp_Activate API once LLCP Link is established after Link Activation Procedure as defined in NFCForum LLCP 1.1 specification section 5.2. \n
*
* \return Status code
* \retval #PH_ERR_SUCCESS               Operation successful.
* \retval #PH_ERR_INVALID_DATA_PARAMS   Invalid Component ID.
