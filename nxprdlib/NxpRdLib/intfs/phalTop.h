...
#define PHAL_TOP_T3T_WRITE_MAX_BLOCKS            0x05U        /**< Max number of blocks supported in one write command. */
...
typedef struct  phalTop_Sw_DataParams
{
    ...
    void * pT5T;                                  /**< Pointer to T5T parameter structure */
...
phStatus_t phalTop_Sw_Init(
    ...
    void * pTopT5T                                /**< [In] Pointer to T5T parameter structure. */
    );
/** @} */
