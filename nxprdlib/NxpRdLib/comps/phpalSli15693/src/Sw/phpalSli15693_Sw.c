...
* $Revision: 4258 $ (NFCRDLIB_V4.010.03.001609 : 4184 $ (NFCRDLIB_V4.010.01.001603 : 3078 ))
                                        ...
                                        )
{
    ...
    memcpy(pDataParams->pUid, pUid, PHPAL_SLI15693_UID_LENGTH);    /* PRQA S 3200 */
    pDataParams->bUidBitLength = PHPAL_SLI15693_SW_UID_COMPLETE;
