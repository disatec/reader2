                                    ...
                                    )
{
    ...
    if((wCcFileSize < 15) || (wCcFileSize == 0xFFFF))
    {
    ...
    if((wCcContentLen > 0) && (wCcContentLen < 15))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }

    printf ("wCCcontentLen %i\n", wCcContentLen);
    ...
    else
    {
        ...
        if((((uint16_t)pCcFile[0] << 8 ) | pCcFile[1]) != wCcContentLen)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate supported version numbers */
        if((pCcFile[2] != 0x30) && (pCcFile[2] != 0x20))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate content length and version number */
        if((pCcFile[2] == 0x30) && (wCcContentLen < 17))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Check for minimum MLe */
        if(((((uint16_t)pCcFile[3] << 8) & 0xFF00) | pCcFile[4]) < 0x0F)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Check for minimum MLc */
        if(((((uint16_t)pCcFile[5] << 8) & 0xFF00) | pCcFile[6]) < 0x01)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate NDEF file ID */
        if((((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10])) == 0x0000)
           || (((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10])) == 0xE102)
           || (((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10])) == 0xE103)
           || (((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10]))== 0x3F00)
           || (((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10])) == 0x3FFF)
           || (((((uint16_t)pCcFile[9] << 8) & 0xFF00) | (pCcFile[10])) == 0xFFFF))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate NDEF TLV and NDEF file size (5 - 0xFFFE) */
        if((pCcFile[2] == 0x20) && ((pCcFile[7] != 0x04) || (pCcFile[8] != 0x06)
           || ((((((uint16_t)pCcFile[11]) << 8) & 0xFF00) | pCcFile[12]) < 0x05)
           || ((((((uint16_t)pCcFile[11]) << 8) & 0xFF00) | pCcFile[12]) == 0xFFFF)))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
#ifdef NXPBUILD__PHCE_T4T_EXT_NDEF
        /* Validate Extended NDEF TLV and NDEF file size (0xFFFF - 0xFFFFFFFE) */
        if((pCcFile[2] == 0x30) && ((pCcFile[7] != 0x06) || (pCcFile[8] != 0x08)
           || (((((uint32_t)pCcFile[11] << 24) & 0xFF000000)
              | (((uint32_t)pCcFile[12] << 16) & 0xFF0000)
              | (((uint32_t)pCcFile[13] << 8) & 0xFF00) | pCcFile[14]) < 0xFFFF)
           || (((((uint32_t)pCcFile[11] << 24) & 0xFF000000)
              | (((uint32_t)pCcFile[12] << 16) & 0xFF0000)
              | (((uint32_t)pCcFile[13] << 8) & 0xFF00) | pCcFile[14]) == 0xFFFFFFFF)))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
#endif /* NXPBUILD__PHCE_T4T_EXT_NDEF */
        /* Validate NDEF read access */
        if(((pCcFile[2] == 0x20) && (pCcFile[13] != 0x00))
           || ((pCcFile[2] == 0x30) && (pCcFile[15] != 0x00)))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate NDEF write access */
        if(((pCcFile[2] == 0x20) && (pCcFile[14] != 0x00) && (pCcFile[14] != 0xFF))
           || ((pCcFile[2] == 0x30) && (pCcFile[16] != 0x00) && (pCcFile[16] != 0xFF)))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
    }
    ...
    while(wCcContentLen > wIndex)
    {
        ...
        if((pCcFile[wIndex] != 0x05) || (pCcFile[wIndex + 1] != 0x06))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate file ID */
        if((((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3])) == 0x0000)
           || (((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3])) == 0xE102)
           || (((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3])) == 0xE103)
           || (((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3]))== 0x3F00)
           || (((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3])) == 0x3FFF)
           || (((((uint16_t)pCcFile[wIndex + 2] << 8) & 0xFF00) | (pCcFile[wIndex + 3])) == 0xFFFF))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate minimum file size */
        if((((((uint16_t)pCcFile[wIndex + 4]) << 8) & 0xFF00) | pCcFile[wIndex + 5]) < 0x03)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate read access */
        if(pCcFile[wIndex + 6] != 0x00)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }

        /* Validate write access */
        if((pCcFile[wIndex + 7] != 0x00) && (pCcFile[wIndex + 7] != 0xFF))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
...
#endif /* NXPBUILD__PHCE_T4T_PROPRIETARY */
#ifndef NXPBUILD__PHCE_T4T_PROPRIETARY
    /* If only NDEF TLV is present, content length shall be 15 or 17 */
    if((wCcContentLen != 15) && (wCcContentLen != 17))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }
#endif /* NXPBUILD__PHCE_T4T_PROPRIETARY */
    ...
    memset(&pCcFile[wCcContentLen], 0, (wCcFileSize - wCcContentLen));  /* PRQA S 3200 */
                                      ...
                                      )
{
    ...
    if((dwNdefFileSize < 5) || (dwNdefFileSize == 0xFFFFFFFF))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }
    ...
    /* Validate file ID */
    if((wNdefFileId == 0x0000) || (wNdefFileId == 0xE102) || (wNdefFileId == 0xE103)
       || (wNdefFileId == 0x3F00) || (wNdefFileId == 0x3FFF) || (wNdefFileId == 0xFFFF))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }

    /* Set NDEF file TLV in CC file */
    if(dwNdefFileSize < 0xFFFE)
    {

        /* Reset CC content if SetCcfile content and SetNdefFile content are not
         * matching in NDEF TLV type / T4T version */
        if(pDataParams->pCcFile[2] != 0x20)
        {
            /* CC Length */
        ...
        /* NDEF File Size */
        pDataParams->pCcFile[11] = (uint8_t)((dwNdefFileSize & 0xFF00) >> 8);
        pDataParams->pCcFile[12] = (uint8_t)(dwNdefFileSize & 0xFF);

    }
#ifdef NXPBUILD__PHCE_T4T_EXT_NDEF
    else
    {
        if(pDataParams->wCcFileSize < 17)
        {
        ...
        /* NDEF File Size */
        pDataParams->pCcFile[11] = (uint8_t)((dwNdefFileSize & 0xFF000000) >> 24);
        pDataParams->pCcFile[12] = (uint8_t)((dwNdefFileSize & 0xFF0000) >> 16);
        pDataParams->pCcFile[13] = (uint8_t)((dwNdefFileSize & 0xFF00) >> 8);
        pDataParams->pCcFile[14] = (uint8_t)(dwNdefFileSize & 0xFF);
    }
#endif /* NXPBUILD__PHCE_T4T_EXT_NDEF */

    /* Update file ID in CC */
    pDataParams->pCcFile[9]  = (uint8_t)((wNdefFileId & 0xFF00) >> 8);
    pDataParams->pCcFile[10] = (uint8_t)(wNdefFileId & 0xFF);

    pDataParams->pNdefFile = pNdefFile;
    pDataParams->dwNdefFileSize = dwNdefFileSize;

    /* Set '0' for remaining file content */
    memset(&pNdefFile[dwNdefContentLen], 0, (dwNdefFileSize - dwNdefContentLen));  /* PRQA S 3200 */
                                             ...
                                             )
{
    ...
    /* Check for file size */
    if((wFileSize < 3) || (wFileSize == 0xFFFF))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }
    ...
    if((wFileId == 0x0000) || (wFileId == 0xE102) || (wFileId == 0xE103)
       || (wFileId == 0x3F00) || (wFileId == 0x3FFF) || (wFileId == 0xFFFF))
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }

    /* Check with the NDEF file ID */
    if((((((uint16_t)pDataParams->pCcFile[9] << 8) & 0xFF00)
    ...
    {
        if(((((uint16_t)pDataParams->pCcFile[wIndex + (bCount * 8) + 2] << 8) & 0xFF00)
           | (pDataParams->pCcFile[wIndex + (bCount * 8) + 3])) == wFileId)
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
    }
    ...
    wIndex += pDataParams->bProprietaryFileCount * 8;

    /* Check if CC file can hold one more TLV */
    if((wIndex + 8) > pDataParams->wCcFileSize)
    {
        return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
    }
    ...
    if((pDataParams->wCcContentLen <= wIndex)
       || (pDataParams->pCcFile[wIndex + 2] != (uint8_t)((wFileId & 0xFF00) >> 8))
       || (pDataParams->pCcFile[wIndex + 3] != (uint8_t)(wFileId & 0xFF)))
    {
        /* Tag */
        pDataParams->pCcFile[wIndex] = 0x05;
        /* Length */
        pDataParams->pCcFile[wIndex + 1] = 0x06;
        ...
        /* Read access */
        pDataParams->pCcFile[wIndex + 6] = 0x00;
        /* Write access */
        pDataParams->pCcFile[wIndex + 7] = 0x00;
    }

    /* File size */
    pDataParams->pCcFile[wIndex + 4] = (uint8_t)((wFileSize & 0xFF00) >> 8);
    pDataParams->pCcFile[wIndex + 5] = (uint8_t)(wFileSize & 0xFF);

    /* Update index */
    wIndex += 8;

    /* Update CC Length to indicate content length till this TLV */
    pDataParams->pCcFile[0] = (uint8_t)((wIndex & 0xFF00) >> 8);
    pDataParams->pCcFile[1] = (uint8_t)(wIndex & 0xFF);
    ...
    /* Set '0' for remaining file content */
    memset(&pFile[wContentLen], 0, (wFileSize - wContentLen));    /* PRQA S 3200 */
                                 ...
                                 )
{
    ...
    if((pRxData[2] == 0x04) && (pRxData[3] == 0x00))
    {
        /* Check the command length and Lc for NDEF APP Select */
        if((wRxDataLen < 0x0D) || (pRxData[4] != 0x07))
        {
    ...
    /* Select file by ID */
    else if((pRxData[2] == 0x00) && (pRxData[3] == 0x0C))
    {
        ...
        if ((wRxDataLen > 0x07) || ((pRxData[4] != 0x02)))
        {
            pDataParams->wStatusWord = PHCE_T4T_ISO7816_FILE_NOT_FOUND;
            *pStatusWord = pDataParams->wStatusWord;
        ...
        wFileId = (uint16_t)((((uint16_t)(pRxData[5])) << 8) & 0xFF00) | ((uint16_t)(pRxData[6]));
        ...
        else if(wFileId == (((((uint16_t)(pDataParams->pCcFile[9])) << 8) & 0xFF00)
...
#ifdef NXPBUILD__PHCE_T4T_PROPRIETARY
        else if(pDataParams->bProprietaryFileCount)
        {
            if(pDataParams->pCcFile[2] == 0x20)
            {
            ...
            for(bCount = 0; bCount < pDataParams->bProprietaryFileCount; bCount++)
            {
                if((((((uint16_t)pDataParams->pCcFile[wIndex + (bCount * 8)]) << 8) & 0xFF00)
                        | (pDataParams->pCcFile[wIndex + (bCount * 8) + 1])) == wFileId)
                {
                    ...
                    pDataParams->bFileWriteAccess = (pDataParams->pCcFile[wIndex + (bCount * 8) + 5]);
                    pDataParams->wStatusWord = PHCE_T4T_ISO7816_SUCCESS;
                    pDataParams->bTagState = PHCE_T4T_STATE_FILE_SELECTED;
                                     ...
                                     )
{
    ...
    wOffset = (uint16_t)((((uint16_t)pRxData[2] << 8) & 0xFF00) | pRxData[3]);
    ...
    if(wRxDataLen == 0x07)
    {
        ...
        wLe = (uint16_t)((((uint16_t)pRxData[wRxDataLen-2] << 8) & 0xFF00) | pRxData[wRxDataLen - 1]);

        /* Check for MLe and expected Length */
        if(((((uint16_t)pDataParams->pCcFile[3] << 8) & 0xFF00) | pDataParams->pCcFile[4]) < wLe)
        {
            pDataParams->wStatusWord = PHCE_T4T_ISO7816_ERR_LENGTH;
            *pStatusWord = pDataParams->wStatusWord;
    ...
    else if(wRxDataLen == 0x05)
    {
        bCommandType = PHCE_T4T_SHORT_LEN_CMD;

        /* Set the Expected Length */
        wLe = pRxData[wRxDataLen - 1];
    ...
    if((((pDataParams->dwFileSize) - wOffset) < wLe) && (wLe != 0x0000))
    {
        pDataParams->wStatusWord = PHCE_T4T_ISO7816_ERR_LENGTH;
        *pStatusWord = pDataParams->wStatusWord;
    ...
    *ppTxData = &(pDataParams->pSelectedFile[wOffset]);
    ...
    else
    {
        ...
        {
            *pTxDataLen = (uint16_t)(((pDataParams->dwFileSize - wOffset) > 0x0100)?
                    0x0100 : (pDataParams->dwFileSize - wOffset));
        }
        else
        {
            *pTxDataLen = (uint16_t)(((pDataParams->dwFileSize - wOffset) > 0xFFFF)?
                                       ...
                                       )
{
    ...
    if(pDataParams->bFileWriteAccess != 0x00)
    {
        pDataParams->wStatusWord = PHCE_T4T_ISO7816_UNSUPPORTED_FUNC;
        *pStatusWord = pDataParams->wStatusWord;
    ...
    if(wOption == PHCE_T4T_RXDEFAULT)
    {
        ...
        if(pRxData[4] != 0x00)
        {
            ...
            if((wRxDataLen - 5) != pDataParams->wLc)
            {
        ...
        {
            bCommandType = PHCE_T4T_EXT_LEN_CMD;
            pDataParams->wLc = (uint16_t)((((uint16_t)pRxData[5] << 8) & 0xFF00) | pRxData[6]);

            if((wRxDataLen - 7) != pDataParams->wLc)
            {
                /* Change error code to length error */
                pDataParams->wStatusWord = PHCE_T4T_ISO7816_ERR_LENGTH;
    ...
    if((uint32_t)(pDataParams->dwFileSize - 2) < (uint32_t)(wOffset + pDataParams->wLc))
    {
        /* Change error code to length error */
        pDataParams->wStatusWord = PHCE_T4T_ISO7816_ERR_LENGTH;
        *pStatusWord = pDataParams->wStatusWord;
    ...
    {
        *ppTxData = &pRxData[5];
        *pTxDataLen = (wRxDataLen - 5);
        pDataParams->wLc = pDataParams->wLc - (wRxDataLen - 5);
    }
    else
    {
        *ppTxData = &pRxData[7];
        *pTxDataLen = (wRxDataLen - 7);
        pDataParams->wLc = pDataParams->wLc - (wRxDataLen - 7);
    }
                                   ...
                                   )
{
    ...
    PH_CHECK_SUCCESS_FCT(status, phOsal_Event_GetEventHandle((void**)&pRxData));
    ...
    while(bExitLoop != true)
    {
        ...
        do
        {
            ...
            case PH_CE_T4T_PROPRIETARY:
                ...
                {
                    memcpy(pDataParams->pAppBuffer, pRxData, wRxDataLen);   /* PRQA S 3200 */
                ...
                PH_CHECK_SUCCESS_FCT(status, phOsal_Event_Post(
                    E_PH_OSAL_EVT_RXDATA_AVAILABLE,
                    E_PH_OSAL_EVT_SRC_LIB,
                    E_PH_OSAL_EVT_DEST_APP));

                /* Loop till TX data is received from AppProcessCmd */
                do
                {
                    /* Wait for TX Data or WTX */
                    PH_CHECK_SUCCESS_FCT(status, phOsal_Event_WaitAny(
                    ...
                    {
                        /* Clear event */
                        PH_CHECK_SUCCESS_FCT(status, phOsal_Event_Consume(
                            E_PH_OSAL_EVT_RTO_TIMEOUT,
        ...
        if(bTxType == PHCE_SEND_DATA)
        {
            ...
            if(wTxDataLen)
            {
                ...
                wTxChainingLen = (wFsd * (((((wTxDataLen + 2 + wNadPresence) % wFsd) == 0)?
                    (((wTxDataLen + 2 + wNadPresence) / wFsd) - 1)
                    : ((wTxDataLen + 2 +  wNadPresence) / wFsd)))) - wNadPresence;
            ...
            aSw[0] = (uint8_t)((pDataParams->wStatusWord & 0xFF00) >> 8);
            aSw[1] = (uint8_t)(pDataParams->wStatusWord & 0xFF);
