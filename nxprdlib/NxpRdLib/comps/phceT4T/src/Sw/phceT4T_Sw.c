                           ...
                           )
{
    ...
    return phceT4T_Sw_Reset(pDataParams);
}
                               ...
                               )
{
    ...
    phOsal_Event_PostwithDetail(
        ...
        E_PH_OSAL_EVT_DETAIL_INTERNAL_ERROR);
                                ...
                                )
{
    ...
    case PHCE_T4T_CONFIG_NDEF_FILE_ID:
        ...
        if((wValue == 0x0000) || (wValue == 0xE102) || (wValue == 0xE103)
           || (wValue == 0x3F00) || (wValue == 0x3FFF) || (wValue == 0xFFFF))
        {
            return (PH_ERR_INVALID_PARAMETER | PH_COMP_CE_T4T);
        }
        pDataParams->pCcFile[9]  = (uint8_t)((wValue & 0xFF00) >> 8);
        pDataParams->pCcFile[10] = (uint8_t)(wValue & 0xFF);
        break;
    ...
    case PHCE_T4T_CONFIG_MLE:
        ...
        pDataParams->pCcFile[3] = (uint8_t)((wValue & 0xFF00) >> 8);
        pDataParams->pCcFile[4] = (uint8_t)(wValue & 0xFF);
        break;
    ...
    case PHCE_T4T_CONFIG_MLC:
        ...
        pDataParams->pCcFile[5] = (uint8_t)((wValue & 0xFF00) >> 8);
        pDataParams->pCcFile[6] = (uint8_t)(wValue & 0xFF);
        break;
                                ...
                                )
{
    ...
    case PHCE_T4T_CONFIG_NDEF_FILE_ID:
        ...
        *pValue = (uint16_t)((((uint16_t)pDataParams->pCcFile[9] << 8) & 0xFF00)
    ...
    case PHCE_T4T_CONFIG_MLE:
        ...
        *pValue = (uint16_t)((((uint16_t)pDataParams->pCcFile[3] << 8) & 0xFF00)
    ...
    case PHCE_T4T_CONFIG_MLC:
        ...
        *pValue = (uint16_t)((((uint16_t)pDataParams->pCcFile[5] << 8) & 0xFF00)
