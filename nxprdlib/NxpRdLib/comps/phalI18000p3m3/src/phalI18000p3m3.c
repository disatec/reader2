                              ...
                              )
{
    ...
    default:
        status = PH_ADD_COMPCODE(PH_ERR_INVALID_DATA_PARAMS, PH_COMP_AL_I18000P3M3);
        break;
    }
    ...
    if ((((status & PH_ERR_MASK) == PH_ERR_SUCCESS) ||
        ...
        (*ppRxBuffer != NULL))
    {
        wByteLength = (*pRxBitLength & 0x07) ? ((*pRxBitLength >> 3) + 1) : (*pRxBitLength >> 3);
                               ...
                               )
{
    ...
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pWordPtr_log, pWordPtr, bWordPtrLength + 1);
                                     ...
                                     )
{
    ...
    PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bWordPtrLength_log, &bWordPtrLength);
    PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bWordCount_log, &bWordCount);
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pData_log, pData, bWordCount << 1);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    ...
    )
{
    ...
    PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bMemBank_log, &bMemBank);
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pBlockPtr_log, pBlockPtr, bBlockPtrLength + 1);
    ...
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pMask_log, pMask, bBlockRange << 1);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
