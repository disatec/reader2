...
#define PHAL_TOP_T4T_SELECTED_NONE                  0x00
#define PHAL_TOP_T4T_SELECTED_NDEF_APP              0x01
#define PHAL_TOP_T4T_SELECTED_CC_FILE               0x02
#define PHAL_TOP_T4T_SELECTED_NDEF_FILE             0x03
