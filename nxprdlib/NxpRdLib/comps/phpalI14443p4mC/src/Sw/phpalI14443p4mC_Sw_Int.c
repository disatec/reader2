...
* $Revision: 4258 $ (NFCRDLIB_V4.010.03.001609 : 4184 $ (NFCRDLIB_V4.010.01.001603 : 3227 ))
                                                ...
                                                )
{
    ...
    {
        PH_CHECK_SUCCESS_FCT(status, phPlatform_Timer_Create(
    ...
    {
        /* Reset Timer */
        PH_CHECK_SUCCESS_FCT(status, phPlatform_Timer_Reset(
            pDataParams->pPlatform,
            pDataParams->dwTimerId));
        ...
        PH_CHECK_SUCCESS_FCT(status, phPlatform_Timer_Start(
            ...
            (ppCallBck_t)(pDataParams->pWtxTimerCallback),
            (void *)pDataParams));
    }
