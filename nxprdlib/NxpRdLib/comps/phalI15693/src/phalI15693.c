                                               ...
                                               )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedReadSingleBlock");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bOption);
    ...
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
    PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_INFO, bOption_log, &bOption);
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, wBlockNo_log, &wBlockNo);
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
    PH_ASSERT_NULL (ppRxBuffer);
    PH_ASSERT_NULL (pRxLength);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedReadSingleBlock((phalI15693_Sw_DataParams_t *)pDataParams, bOption, wBlockNo, ppRxBuffer, pRxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                                  ...
                                                  )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedReadMultipleBlocks");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wBlockNo);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wNumBlocks);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedReadMultipleBlocks ((phalI15693_Sw_DataParams_t *)pDataParams, bOption, wBlockNo, wNumBlocks, ppRxBuffer, pRxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                                ...
                                                )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedWriteSingleBlock");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wBlockNo);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(pTxBuffer);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedWriteSingleBlock ((phalI15693_Sw_DataParams_t *)pDataParams, bOption, wBlockNo, pTxBuffer, wTxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                                   ...
                                                   )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedWriteMultipleBlocks");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wBlockNo);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wNumBlocks);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedWriteMultipleBlocks ((phalI15693_Sw_DataParams_t *)pDataParams, bOption, wBlockNo, wNumBlocks, pTxBuffer, wTxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                         ...
                                         )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedLockBlock");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(bOption);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wBlockNo);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedLockBlock ((phalI15693_Sw_DataParams_t *)pDataParams, bOption, wBlockNo);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                                    ...
                                                    )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedGetSystemInformation");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(ppRxBuffer);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
    PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedGetSystemInformation ((phalI15693_Sw_DataParams_t *)pDataParams, ppRxBuffer, pRxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
                                                              ...
                                                              )
{
    ...
    PH_LOG_HELPER_ALLOCATE_TEXT(bFunctionName, "phalI15693_ExtendedGetMultipleBlockSecurityStatus");
    /*PH_LOG_HELPER_ALLOCATE_PARAMNAME(pDataParams);*/
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wBlockNo);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(wNumBlocks);
    PH_LOG_HELPER_ALLOCATE_PARAMNAME(ppRxBuffer);
...
#ifdef NXPBUILD__PHAL_I15693_SW
    case PHAL_I15693_SW_ID:
        status = phalI15693_Sw_ExtendedGetMultipleBlockSecurityStatus ((phalI15693_Sw_DataParams_t *)pDataParams, wBlockNo, wNumBlocks, ppRxBuffer, pRxLength);
        break;
#endif /* NXPBUILD__PHAL_I15693_SW */
