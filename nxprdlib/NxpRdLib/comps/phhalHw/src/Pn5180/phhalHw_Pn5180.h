...
** $Author:nxp62726 $
* $Revision$ (NFCRDLIB_V4.010.03.001609  (NFCRDLIB_V4.010.01.001603 : 3577 ))
...
*/
#define PHHAL_HW_PN5180_SYSTEM_IDLE_CMD                 0x0   /*stops all ongoing communication and set the CLIF to IDLE mode*/
#define PHHAL_HW_PN5180_SYSTEM_TRANSMIT_CMD             0x1  /*starts a transmission immediately*/
#define PHHAL_HW_PN5180_SYSTEM_RECEIVE_CMD              0x2  /*enables the receiver. After end of reception the bits are clear and IDLE*/
#define PHHAL_HW_PN5180_SYSTEM_TRANSEIVE_CMD            0x3  /*Transceive command; initiates a transceive cycle. Note: Depending on the value of the Initiator bit a transmission is started or the receiver is enabled Note: The transceive command does not finish automatically. It stays in the transceive cycle until stopped via the IDLE/StopCom command */
#define PHHAL_HW_PN5180_SYSTEM_KEEP_CMD                 0x4  /*This command does not change the content of the command register and might be used in case other bits in the register are to be changed*/
#define PHHAL_HW_PN5180_SYSTEM_LOOPBACK_CMD             0x5  /*This command is for test purposes only. It starts a transmission and at the same enables the receiver*/


#define PHHAL_HW_PN5180_TR_RX_PRESCALAR                 0x7F  /* Tx and Rx Prescaler to 0x7F with 1 Etu ref*/
/**
Set Listen Parameter Constants
*/
#define PHHAL_HW_PN5180_SET_LISTEN_LEN              24
#define PHHAL_HW_PN5180_SET_LISTEN_EEPROM_ADDR      0x40
#define PHHAL_HW_PN5180_SET_LISTEN_SENRES_LEN       2
#define PHHAL_HW_PN5180_SET_LISTEN_NFCID1_LEN       3
#define PHHAL_HW_PN5180_SET_LISTEN_SELRES_LEN       1
#define PHHAL_HW_PN5180_SET_LISTEN_POLLRES_LEN      18
#define PHHAL_HW_PN5180_SET_LISTEN_NFCID3_LEN       1

/**
Set EMD Modes
*/
#define PHHAL_HW_PN5180_NO_EMD      0   /* .. no EMD    */
#define PHHAL_HW_PN5180_EMD_2P3     0x185   /*EMVCO 2.3.1*/
#define PHHAL_HW_PN5180_EMD_2P5     0x107   /*EMVCO 2.5*/
...
/**
uses the timeout set with either #PHHAL_HW_CONFIG_TIMING_US or #PHHAL_HW_CONFIG_TIMING_MS as abort criteria.
...
*/
#define PHHAL_HW_PN5180_LPCD_MODE_POWERDOWN_GUARDED  0x02U
...
*/
#define     LPCD_REFVAL_CONTROL_MASK        0x03


/**
Clear all INTERUPT MASK
*/
#define PHHAL_HW_PN5180_IRQ_SET_CLEAR_ALL_MASK      0xFFFFF

/**
Prescalar for Millisec
*/
#define PHHAL_HW_PN5180_MS_TIMEOUT_PRESCALAR        0x3C
