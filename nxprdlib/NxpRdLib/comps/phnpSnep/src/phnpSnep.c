                               ...
                               )
{
    ...
    if (dwSnepRxBufferSize) PH_ASSERT_NULL (pbSnepRxBuffer);
                        ...
                        )
{
    ...
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
    if (dwTxBufferSize) PH_ASSERT_NULL (pTxBuffer);
                        ...
                        )
{
    ...
    PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
    PH_ASSERT_NULL (pDataParams);
    if (dwNdefMsgLen) PH_ASSERT_NULL (pNdefMsg);
    if (dwAppBufSize) PH_ASSERT_NULL (pRxBuffer);
